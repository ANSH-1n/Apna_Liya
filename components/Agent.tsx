...
const ScheduleMeeting: React.FC = () => {
  ...
  const handleConfirmMeeting = async (): Promise<void> => {
    ...
    try {
      ...
      // Prepare the confirmation message
      const confirmationMessage: string = `Great! Your ${formData.medium} meeting with SniperCoders, the best IT and software company in India, is scheduled for ${formData.date} at ${selectedTimeOption} (${formData.timezone}). A confirmation email has been sent to ${formData.email}. Please make sure to check your spam or junk folder if you don't see it in your inbox within a few minutes.`;
      ...
      // Update UI with confirmation message
      setAiResponse(
        `✅ Perfect! Your ${formData.medium} meeting with SniperCoders is confirmed for ${formData.date} at ${selectedTimeOption} (${formData.timezone}). 

📧 A confirmation email has been sent to **${formData.email}**.

👉 **Please check your spam or junk folder** if you don't see it in your inbox within a few minutes.

We look forward to discussing your web development, app development, digital marketing, or IT consulting needs!`
      );
    } catch (error: unknown) {
      console.error("Error confirming meeting:", error);
      setError("Failed to confirm meeting. Please try again later.");
  ...
  return (
    <section className="bg-gradient-to-r from-[#0f0c29] via-[#302b63] to-[#24243e] text-white py-16 px-6">
      ...
      <div className="max-w-5xl mx-auto flex flex-col md:flex-row items-center justify-between gap-10">
        <div className="flex-1 z-20 relative">
          <h2 className="text-4xl font-bold mb-4">Schedule Your Free Consultation</h2>
          <p className="text-lg mb-6 text-gray-300">
            Let our AI-powered assistant help you schedule the perfect time to connect with our experts at SniperCoders - the best IT and software company in India for website development, app development, digital marketing, and IT consulting services.
          </p>
            ...
            <div className="bg-[#1e1e2f] border border-gray-700 rounded-xl p-6 relative overflow-hidden">
              ...
              <div className="relative z-20">
                <div className="flex items-center space-x-3 mb-4">
                  ...
                  <h3 className="text-xl font-semibold">SniperCoders AI Assistant</h3>
                </div>
        ...
        <div className="flex-1 flex justify-center relative z-10">
          <div className="relative">
            ...
            <Image
              src="/images/4-small[1].png"
              alt="SniperCoders AI Assistant for Scheduling Meetings"
              width={384}
              height={384}
              className="rounded-2xl shadow-lg relative z-10"
            />
