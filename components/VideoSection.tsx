    ...
    <section className="relative overflow-hidden bg-gradient-to-b from-black/95 via-purple-900/20 to-black/95">
      ...
      <div className="relative z-10 container mx-auto px-4 sm:px-6 lg:px-8 py-12 md:py-16 lg:py-20 xl:py-24">
        ...
        >
          ...
          <div className="relative bg-gradient-to-br from-slate-800 to-slate-900 p-1 md:p-2 rounded-xl md:rounded-2xl shadow-xl lg:shadow-2xl">
            ...
            <div className="relative rounded-lg md:rounded-xl overflow-hidden aspect-video bg-black">
              <video
                ...
                playsInline
                poster="https://via.placeholder.com/1280x720/1e293b/8b5cf6?text=SniperCoders+Showreel"
                aria-label="SniperCoders portfolio video showcasing website development, app development, and digital marketing projects"
              >
                <source src="https://res.cloudinary.com/dzoxwk1jc/video/upload/v1768070466/sniper_video_section_r1kcfs.mp4" type="video/mp4" />
                Your browser does not support the video tag.
              </video>
          ...
          {/* Video caption/title - SEO Enhanced */}
          <motion.div
            initial={{ opacity: 0 }}
            animate={{ opacity: 1 }}
            transition={{ delay: 0.5, duration: 0.8 }}
          ...
          >
            <h2 className="text-xl md:text-2xl lg:text-3xl font-bold text-white mb-2">
              See SniperCoders&apos; Work in Action
            </h2>
            <p className="text-gray-300 text-sm md:text-base lg:text-lg max-w-2xl mx-auto mb-2">
              Watch how we transform ideas into stunning digital experiences with best <span className="text-cyan-400 font-medium">website development</span>, <span className="text-purple-400 font-medium">app development</span>, and <span className="text-pink-400 font-medium">digital marketing</span> in India
            </p>
            <p className="text-gray-400 text-xs md:text-sm max-w-xl mx-auto">
              Portfolio showcase featuring custom coded websites, mobile applications, eCommerce solutions, and successful digital marketing campaigns
            </p>
          </motion.div>
        </motion.div>
        ...
        >
          <h3 className="text-center text-lg md:text-xl font-semibold text-gray-300 mb-6">
            <span className="text-cyan-400">SniperCoders</span> - Best IT & Software Company in India
          </h3>
          <div className="grid grid-cols-2 md:grid-cols-4 gap-4 md:gap-6">
            {[
              { label: 'Projects Delivered', value: '30+', desc: 'Successful IT projects' },
              { label: 'Happy Clients', value: '20+', desc: 'Satisfied businesses' },
              { label: 'Client Satisfaction', value: '4.9/5', desc: 'Average rating' },
              { label: 'Expert Support', value: '24/7', desc: 'Always available' }
            ].map((stat, index) => (
              <div 
                key={index} 
                className="bg-gradient-to-br from-purple-900/20 to-blue-900/20 backdrop-blur-sm rounded-lg md:rounded-xl p-4 text-center border border-purple-500/20 hover:border-purple-500/40 transition-all duration-300"
              >
                <div className="text-2xl md:text-3xl lg:text-4xl font-bold text-transparent bg-clip-text bg-gradient-to-r from-purple-400 to-blue-400">
                  {stat.value}
                </div>
                <div className="text-gray-300 text-xs md:text-sm font-semibold mt-1">
                  {stat.label}
                </div>
        ...
        >
          <p className="text-sm text-gray-400 leading-relaxed">
            As the <span className="text-cyan-400 font-semibold">best software and IT company in India</span>, SniperCoders specializes in 
            <span className="text-purple-400 font-medium"> website development near you</span>, 
            <span className="text-blue-400 font-medium"> mobile app development</span>, 
            <span className="text-pink-400 font-medium"> custom software solutions</span>, 
            <span className="text-orange-400 font-medium"> digital marketing services</span> (SEO, Google Ads, Meta Ads), 
            <span className="text-green-400 font-medium"> IT consulting</span>, and 
            <span className="text-yellow-400 font-medium"> AI agent development</span>. 
            With <span className="font-semibold">30+ successful projects</span> and <span className="font-semibold">100% customer satisfaction</span>, 
