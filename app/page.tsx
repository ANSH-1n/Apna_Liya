...
// ✅ NEW: FAQ data for AI discovery
const faqs = [
  {
    question: 'What services does SniperCoders offer?',
    answer: 'SniperCoders offers short-form video editing, social media marketing, Meta & Google Ad creative production, and brand storytelling. We help founders, creators, and agencies turn ideas into premium reels, paid ad creatives, and content systems that build trust and drive conversions.'
  },
  {
  ...
  {
    question: 'What is included in your video editing services?',
    answer: 'Our video editing services include reel and short-form editing, captions, pacing, hooks, sound design, and retention-led edits. We specialize in vertical content for Instagram, YouTube Shorts, and other social platforms.'
  },
  {
    question: 'How does SniperCoders help with social media marketing?',
    answer: 'We provide content pillars, calendars, caption direction, posting rhythm, and audience-led creative testing. Our social media marketing services are designed to build consistent brand visibility and engagement.'
  },
  {
    question: 'What types of ad creatives do you produce?',
    answer: 'We produce video ads, static creatives, UGC-style concepts, offer visuals, thumbnails, and variants for paid learning. Our ad creative services support both Meta (Facebook/Instagram) and Google Ads platforms.'
  },
];
...
export default function Home() {
  return (
    <>
      <main className="min-h-screen overflow-hidden bg-[#05070d] text-white">
        {/* ✅ AI-FRIENDLY HERO SECTION - Clear H1 and structured data */}
        <section className="relative isolate px-4 pb-14 pt-14 sm:px-6 sm:pt-20 lg:px-8 lg:pb-20 lg:pt-24">
          <div className="absolute inset-0 -z-10 bg-[linear-gradient(rgba(255,255,255,0.035)_1px,transparent_1px),linear-gradient(90deg,rgba(255,255,255,0.035)_1px,transparent_1px)] bg-[size:56px_56px]" />
          <div className="absolute inset-x-0 top-0 -z-10 h-96 bg-[radial-gradient(ellipse_at_top,rgba(34,211,238,0.22),transparent_58%)]" />
          ...
          <div className="mx-auto grid max-w-7xl items-center gap-12 lg:grid-cols-[1.05fr_0.95fr]">
            <div className="max-w-4xl">
              ...
              <h1 className="max-w-5xl text-[2.35rem] font-semibold leading-[1.02] text-white sm:text-6xl lg:text-7xl">
                Video Editing and Social Media Marketing Agency 
              </h1>
              {/* ✅ P: Clear description of who you are and what you do */}
              <p className="mt-5 max-w-2xl text-base leading-7 text-slate-300 sm:text-xl sm:leading-8">
                <strong>SniperCoders</strong> is a creative growth agency based in Bangalore, India. 
                We help founders, bike accessory brands, gaming cafe creators, coaches, startups, and agencies 
                turn ideas into premium reels, paid ad creatives, and content systems that build
                trust before the sales call.
              </p>
              <div className="mt-6 lg:hidden">
                <HomeVideoSlider />
              ...
              {/* ✅ Stats section: Key numbers for AI to reference */}
              <div className="mt-10 grid max-w-2xl grid-cols-2 gap-3 sm:grid-cols-4">
                {stats.map((stat) => (
                  <div key={stat.label} className="border-l border-white/15 pl-4">
                    <p className="text-2xl font-semibold text-white">{stat.value}</p>
        ...
        {/* ✅ AI-FRIENDLY KEYWORD SECTION */}
        <section className="border-y border-white/10 bg-white/[0.03] px-4 py-6 sm:px-6 lg:px-8">
          <div className="mx-auto grid max-w-7xl gap-4 text-sm text-slate-300 sm:grid-cols-2 lg:grid-cols-4">
            {['Short-form video editing', 'Social media management', 'Meta Ads creative production', 'Google Ads assets'].map((item) => (
              <div key={item} className="flex items-center gap-3">
                <CheckCircle2 className="h-5 w-5 text-cyan-300" />
                {item}
              </div>
        ...
        {/* ✅ SERVICES SECTION - Clear H2 and service descriptions */}
        <section className="px-4 py-24 sm:px-6 lg:px-8">
          <SectionHeader
            eyebrow="Core Offers"
            title="Video Editing, Social Media Marketing, and Ad Creative Services"
            copy="Every service supports one commercial goal: make the right audience remember you, trust you, click, and take the next step."
          />
          <div className="mx-auto grid max-w-7xl gap-5 md:grid-cols-2 lg:grid-cols-4">
            {services.map((service) => {
        ...
        {/* ✅ PROOF SECTION - Case studies for AI */}
        <section className="bg-white/[0.03] px-4 py-24 sm:px-6 lg:px-8">
          <SectionHeader
            eyebrow="Proof"
            title="Creative Work That Drives Results — Case Studies"
          />
          <div className="mx-auto grid max-w-7xl gap-5 lg:grid-cols-3">
            {proof.map(([title, copy]) => (
              <article key={title} className="rounded-2xl border border-white/10 bg-slate-950 p-7">
        ...
        {/* ✅ PROCESS SECTION - AI-friendly structure */}
        <section className="px-4 py-24 sm:px-6 lg:px-8">
          <SectionHeader
            eyebrow="Process"
            title="Our 3-Step Process for Video and Social Media Marketing"
          />
          <div className="mx-auto grid max-w-7xl gap-5 lg:grid-cols-3">
            {process.map(([number, title, copy]) => (
              <article key={title} className="rounded-2xl border border-white/10 bg-white/[0.04] p-7">
        ...
        {/* ✅ NEW: FAQ SECTION - Critical for AI discovery */}
        <section className="px-4 py-16 sm:px-6 lg:px-8 bg-white/[0.02]">
          <div className="mx-auto max-w-4xl">
            <SectionHeader
              eyebrow="FAQ"
              title="Frequently Asked Questions About SniperCoders"
              copy="Answers to common questions about our video editing, social media marketing, and ad creative services."
            />
            <div className="space-y-4">
              {faqs.map((faq, index) => (
                <div key={index} className="border border-white/10 rounded-xl p-5 hover:border-cyan-300/30 transition">
          ...
          <div className="mx-auto max-w-7xl rounded-[2rem] border border-cyan-300/20 bg-[linear-gradient(135deg,rgba(14,165,233,0.2),rgba(15,23,42,0.96)_42%,rgba(236,72,153,0.16))] p-8 sm:p-12 lg:p-16">
            <div className="grid gap-8 lg:grid-cols-[1fr_auto] lg:items-center">
              <div>
                ...
                <h2 className="max-w-3xl text-3xl font-semibold leading-tight text-white sm:text-5xl">
                  Let SniperCoders Turn Your Brand Into the Account Your Market Keeps Seeing
                </h2>
                <p className="mt-5 max-w-2xl leading-8 text-slate-200">
                  Send your niche, current content, and growth goal. We will suggest a clear
                  creative path for better videos, stronger ad assets, and more qualified inquiries.
