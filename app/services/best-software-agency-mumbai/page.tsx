...
const SERVICES = [
  { icon: <Globe className="w-7 h-7" />, title: "Website Development Mumbai", desc: "Premium website design company in Mumbai. Business websites, fintech portals, production house sites & enterprise eCommerce platforms built for Mumbai's competitive digital scene.", gradient: "from-cyan-500 to-teal-600" },
  { icon: <Smartphone className="w-7 h-7" />, title: "Mobile App Development Mumbai", desc: "Top app development agency in Mumbai. Fintech apps, food delivery platforms, local logistics apps & BFSI mobile solutions for Mumbai's smartphone-savvy consumer base.", gradient: "from-violet-500 to-purple-700" },
  { icon: <Code className="w-7 h-7" />, title: "Custom Software Development Mumbai", desc: "Enterprise software solutions in Mumbai. Trading platforms, NBFC software, inventory management, ERP & enterprise SaaS for Mumbai's diverse industries.", gradient: "from-blue-500 to-indigo-600" },
  { icon: <TrendingUp className="w-7 h-7" />, title: "Digital Marketing Agency Mumbai", desc: "Local SEO, performance marketing & social media strategies to help Mumbai brands stand out in a crowded digital market.", gradient: "from-rose-500 to-pink-600" },
  { icon: <Users className="w-7 h-7" />, title: "IT Consulting Mumbai", desc: "Expert IT consultants in Mumbai. Technology strategy for Mumbai's corporates, financial institutions, media companies & startups looking to scale digitally.", gradient: "from-amber-500 to-orange-600" },
  { icon: <Award className="w-7 h-7" />, title: "UI/UX Design Agency Mumbai", desc: "Product design and brand identities built for Mumbai's high-design, trend-forward consumer market.", gradient: "from-fuchsia-500 to-pink-600" },
];

const BUSINESS_CATEGORIES = [
  { icon: <Landmark className="w-5 h-5" />, label: "Banks in BKC", color: "text-cyan-400" },
  { icon: <Banknote className="w-5 h-5" />, label: "Fintech in Nariman Point", color: "text-emerald-400" },
  { icon: <Briefcase className="w-5 h-5" />, label: "Startups in Bandra", color: "text-indigo-400" },
  { icon: <Film className="w-5 h-5" />, label: "Film Production in Andheri", color: "text-violet-400" },
  { icon: <Utensils className="w-5 h-5" />, label: "Restaurants in Colaba", color: "text-orange-400" },
  { icon: <Coffee className="w-5 h-5" />, label: "Cafés in Bandra", color: "text-amber-400" },
  { icon: <Hotel className="w-5 h-5" />, label: "Hotels in Juhu", color: "text-blue-400" },
  { icon: <ShoppingBag className="w-5 h-5" />, label: "Fashion in Linking Road", color: "text-pink-400" },
  { icon: <Car className="w-5 h-5" />, label: "Luxury Cars in Worli", color: "text-cyan-300" },
  { icon: <GraduationCap className="w-5 h-5" />, label: "Ed-Tech in Powai", color: "text-green-400" },
  { icon: <HeartPulse className="w-5 h-5" />, label: "Hospitals in Parel", color: "text-red-400" },
  { icon: <Plane className="w-5 h-5" />, label: "Travel in Fort", color: "text-sky-400" },
  { icon: <Dumbbell className="w-5 h-5" />, label: "Gyms in Andheri West", color: "text-lime-400" },
  { icon: <Home className="w-5 h-5" />, label: "Real Estate in Worli", color: "text-teal-400" },
  { icon: <Truck className="w-5 h-5" />, label: "Logistics in Bhiwandi", color: "text-yellow-400" },
  { icon: <Music className="w-5 h-5" />, label: "Nightlife in Lower Parel", color: "text-rose-400" },
  { icon: <ShoppingCart className="w-5 h-5" />, label: "D2C Brands Mumbai", color: "text-emerald-400" },
  { icon: <Wrench className="w-5 h-5" />, label: "Home Services Mumbai", color: "text-orange-300" },
  { icon: <Factory className="w-5 h-5" />, label: "Textiles in Dadar", color: "text-gray-400" },
  { icon: <Building2 className="w-5 h-5" />, label: "Co-working in BKC", color: "text-purple-300" },
  { icon: <Wifi className="w-5 h-5" />, label: "IT Services in Goregaon", color: "text-cyan-300" },
  { icon: <HeartPulse className="w-5 h-5" />, label: "Pharma in Mumbai", color: "text-pink-300" },
  { icon: <TreePine className="w-5 h-5" />, label: "NGOs in Mumbai", color: "text-green-300" },
  { icon: <ShoppingBag className="w-5 h-5" />, label: "Jewellery in Zaveri Bazaar", color: "text-yellow-300" },
  { icon: <Building className="w-5 h-5" />, label: "Corporates in Nariman Point", color: "text-blue-300" },
  { icon: <Store className="w-5 h-5" />, label: "Retail in Crawford Market", color: "text-amber-300" },
  { icon: <Theater className="w-5 h-5" />, label: "Theatre & Arts in Prithvi", color: "text-fuchsia-300" },
  { icon: <Tent className="w-5 h-5" />, label: "Dharavi SMEs", color: "text-orange-400" },
];

const STATS = [
  { value: "30+", label: "Mumbai Projects Delivered" },
...
const FAQS = [
  {
    ...
    a: "SniperCoders is a growing software agency serving Mumbai, with experience across web development, mobile apps, and digital marketing for businesses across Bandra, BKC, Lower Parel, Nariman Point, and the wider Mumbai Metropolitan Region."
  },
  {
    q: "Can SniperCoders handle enterprise-level projects for Mumbai corporates?",
    a: "Yes. We build enterprise-grade platforms — from fintech dashboards for BFSI clients in BKC to large-scale eCommerce systems for retail businesses in Nariman Point — with attention to security and scalability appropriate for Mumbai's corporate sector."
  },
  {
    q: "Do you specialize in fintech or BFSI digital solutions?",
    a: "Yes. We've built payment platforms, portfolio management portals, and customer-facing BFSI tools with compliance and security in mind, for clients in Nariman Point, BKC, and Fort."
  },
  {
    q: "How do you handle SEO for such a competitive market like Mumbai?",
    a: "Mumbai requires neighbourhood-level hyperlocal SEO (Bandra, Andheri, Lower Parel, BKC, etc.) combined with industry-specific keyword strategy. We run technical audits plus content strategies to build rankings systematically over time."
  },
  {
    q: "Do you support Marathi language content?",
    a: "Yes. We support Marathi, Hindi and English — useful for reaching both Mumbai's local Marathi-speaking audience and its pan-Indian population, since most businesses only target English keywords."
  },
  {
    q: "Can you build websites for media & production houses?",
    a: "Yes. We build portfolio websites, production house showcase sites, and marketing landing pages for clients in Andheri, Versova, and Goregaon, with a focus on visual, video-first presentation."
  },
  {
    q: "How much does a website cost in Mumbai?",
    a: "A professional business website in Mumbai typically ranges from ₹15,000 to ₹1,50,000+ depending on complexity. We offer transparent pricing with no hidden charges for small businesses in Dadar, Ghatkopar, Mulund, and across Mumbai."
  },
];
    ...
    <div className="min-h-screen bg-[#05070d] text-white font-sans overflow-x-hidden">
      ...
      >
        ...
        <div className="relative z-10 container mx-auto px-4 py-20 text-center">
          ...
          >
            <Crown className="w-4 h-4" /> Software Agency in Mumbai • 30+ Projects Delivered
          </motion.div>
          ...
          >
            SniperCoders works with Mumbai&apos;s businesses — from <strong className="text-cyan-400">Bandra startups to BKC corporates, Juhu restaurants to Andheri film studios</strong> — on websites, fintech apps, custom software &amp; digital marketing.
          </motion.p>
        ...
        <div className="container mx-auto px-4 max-w-5xl">
          ...
          >
            ...
            <div className="space-y-4 text-gray-300 leading-relaxed">
              <p>
                <strong className="text-white">Mumbai</strong> — India&apos;s financial capital, entertainment hub and commercial powerhouse — is home to millions of digital-first consumers. From the skyscrapers of <strong className="text-cyan-400">Nariman Point and BKC</strong> to the creative energy of <strong className="text-cyan-400">Bandra and Versova</strong>, from the retail chaos of <strong className="text-cyan-400">Linking Road and Colaba Causeway</strong> to the industrial belt of <strong className="text-cyan-400">Bhiwandi</strong> — every neighbourhood has its own digital dynamics.
              </p>
              <p>
                Many Mumbai businesses still work with outdated websites or no online presence at all. <strong className="text-white">SniperCoders</strong> works within these micro-markets to build digital strategies that resonate locally while scaling nationally.
              </p>
              <p>
                Whether you&apos;re a <strong className="text-white">Juhu-based restaurant</strong>, a <strong className="text-white">Worli fintech startup</strong>, a <strong className="text-white">Versova film production house</strong>, a <strong className="text-white">Dadar textile trader</strong>, or a <strong className="text-white">Goregaon logistics company</strong> — <strong className="text-cyan-400">contact us at +91 7006377796 or snipercoders25@gmail.com</strong> for a free consultation.
              </p>
            </div>
          </motion.div>
        </div>
        ...
        <div className="container mx-auto px-4">
          <motion.div initial="hidden" whileInView="show" viewport={{ once: true }} variants={fadeUp} className="text-center mb-14">
            ...
            <p className="text-gray-400 max-w-2xl mx-auto">
              Digital solutions built for the speed and scale of Mumbai&apos;s business ecosystem — web development, mobile apps, SEO, and more.
            </p>
          </motion.div>
      ...
      <section className="py-20 bg-gradient-to-b from-transparent via-cyan-950/10 to-transparent">
        <div className="container mx-auto px-4">
          <motion.div initial="hidden" whileInView="show" viewport={{ once: true }} variants={fadeUp} className="text-center mb-14">
            ...
            <p className="text-gray-400 max-w-2xl mx-auto">
              From <strong className="text-cyan-400">Dalal Street fintech</strong> to <strong className="text-cyan-400">Dharavi manufacturing</strong>, <strong className="text-cyan-400">production studios</strong> to <strong className="text-cyan-400">Bandra cafés</strong> — every Mumbai industry needs a digital presence.
            </p>
          </motion.div>
        ...
        <div className="container mx-auto px-4 max-w-5xl">
          <motion.div initial="hidden" whileInView="show" viewport={{ once: true }} variants={fadeUp} className="text-center mb-12">
            <h2 className="text-3xl md:text-4xl font-extrabold" style={{ fontFamily: "'Syne', sans-serif" }}>
              The <span className="bg-gradient-to-r from-cyan-400 to-teal-400 bg-clip-text text-transparent">SniperCoders</span> Approach in Mumbai
            </h2>
            <p className="text-gray-400 mt-4 max-w-2xl mx-auto">
              Here&apos;s how we work with Mumbai businesses:
            </p>
          </motion.div>
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
            {[
              "Hyperlocal SEO covering Bandra, Andheri, BKC, Lower Parel, Nariman Point & suburbs",
              "Marathi, Hindi & English multilingual content for local reach",
              "Fintech & BFSI-aware architecture for Nariman Point & BKC clients",
              "Media production portfolio websites for Andheri, Versova & Goregaon studios",
              "Landing pages for Mumbai's real estate market in Worli & Lower Parel",
              "Shopify & WooCommerce builds for Mumbai's fashion & lifestyle D2C brands",
              "WhatsApp Business API integrations for local service businesses",
              "Analytics & conversion tracking for ad campaigns",
              ...
              "Security-conscious builds for corporate clients in Nariman Point & BKC",
      ...
      <section className="py-12 bg-gradient-to-r from-cyan-900/20 via-teal-900/10 to-cyan-900/20 border-y border-gray-800/50">
        <div className="container mx-auto px-4 text-center">
          ...
          <p className="text-xl md:text-2xl font-medium text-gray-200 max-w-3xl mx-auto">
            We work with fintech startups, media houses, retail brands, and corporates across Mumbai to build websites, apps, and marketing campaigns suited to the city&apos;s fast pace.
          </p>
      ...
      <section className="py-20">
        <div className="container mx-auto px-4 max-w-3xl">
          <motion.div initial="hidden" whileInView="show" viewport={{ once: true }} variants={fadeUp} className="text-center mb-12">
            ...
            <p className="text-gray-400">Common questions about software development, website design, and digital marketing in Mumbai.</p>
          </motion.div>
          ...
          >
            ...
            <div className="relative z-10">
              ...
              <p className="text-gray-300 mb-8 max-w-2xl mx-auto">
                Mumbai&apos;s consumers are online right now. From <strong className="text-cyan-400">BKC boardrooms</strong> to <strong className="text-cyan-400">Bandra cafés</strong>, <strong className="text-cyan-400">Juhu restaurants</strong> to <strong className="text-cyan-400">Andheri studios</strong> — SniperCoders helps put your brand in front of them.
              </p>
