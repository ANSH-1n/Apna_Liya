...
const SERVICES = [
  ...
  },
  {
    ...
    desc: "Local SEO, Google Ads and Punjabi + Hindi + English social media marketing strategies for businesses across Chandigarh, Mohali and Panchkula.",
  ...
  },
  {
    ...
    desc: "Refined, aspirational brand identities that reflect Chandigarh&apos;s reputation as India&apos;s most planned, design-forward city.",
    gradient: "from-fuchsia-500 to-pink-600",
  },
];

const BUSINESS_CATEGORIES = [
  { icon: <Home className="w-5 h-5" />, label: "Real Estate in Mohali", color: "text-teal-400" },
  { icon: <Hotel className="w-5 h-5" />, label: "Hotels in Sector 17", color: "text-blue-400" },
  { icon: <Utensils className="w-5 h-5" />, label: "Dhabas in Mohali", color: "text-orange-400" },
  { icon: <Coffee className="w-5 h-5" />, label: "Cafés in Sector 35", color: "text-amber-400" },
  { icon: <ShoppingBag className="w-5 h-5" />, label: "Boutiques in Panchkula", color: "text-pink-400" },
  { icon: <GraduationCap className="w-5 h-5" />, label: "Schools in Chandigarh", color: "text-green-400" },
  { icon: <GraduationCap className="w-5 h-5" />, label: "Ed-Tech in Mohali", color: "text-lime-400" },
  { icon: <HeartPulse className="w-5 h-5" />, label: "Hospitals in Panchkula", color: "text-red-400" },
  { icon: <Car className="w-5 h-5" />, label: "Car Dealers in Zirakpur", color: "text-cyan-400" },
  { icon: <Dumbbell className="w-5 h-5" />, label: "Gyms in Sector 8", color: "text-lime-300" },
  { icon: <Plane className="w-5 h-5" />, label: "Travel in Sector 22", color: "text-sky-400" },
  { icon: <Truck className="w-5 h-5" />, label: "Logistics in Mohali", color: "text-yellow-400" },
  { icon: <Music className="w-5 h-5" />, label: "Wedding Planners", color: "text-rose-400" },
  { icon: <Landmark className="w-5 h-5" />, label: "Finance in Sector 9", color: "text-blue-300" },
  { icon: <ShoppingCart className="w-5 h-5" />, label: "D2C Brands Tricity", color: "text-emerald-400" },
  { icon: <Wrench className="w-5 h-5" />, label: "Home Services", color: "text-orange-300" },
  { icon: <Factory className="w-5 h-5" />, label: "MSME in Punjab", color: "text-gray-400" },
  { icon: <Building2 className="w-5 h-5" />, label: "IT Companies", color: "text-purple-300" },
  { icon: <TreePine className="w-5 h-5" />, label: "Agriculture", color: "text-green-300" },
  { icon: <Wifi className="w-5 h-5" />, label: "Telecom & ISPs", color: "text-cyan-300" },
  { icon: <Camera className="w-5 h-5" />, label: "Photography Studios", color: "text-violet-400" },
  { icon: <Briefcase className="w-5 h-5" />, label: "Law Firms", color: "text-indigo-400" },
  { icon: <HeartPulse className="w-5 h-5" />, label: "Dental Clinics", color: "text-pink-300" },
  { icon: <ShoppingBag className="w-5 h-5" />, label: "Jewellery Stores", color: "text-yellow-300" },
];

const STATS = [
  { value: "30+", label: "Tricity Projects Delivered" },
...
const FAQS = [
  {
    ...
    a: "SniperCoders is a growing software agency serving Chandigarh, Mohali, and Panchkula, with experience across web development, mobile apps, and digital marketing for local businesses in Sector 17, Mohali IT Park, and Panchkula&apos;s commercial zones."
  },
  {
    q: "Why should Chandigarh businesses invest in digital marketing now?",
    a: "Chandigarh has one of India&apos;s highest per-capita incomes and an extremely active online consumer base. Searches for real estate in Mohali, restaurants in Sector 17, schools in Panchkula, and clinics across Tricity are growing month on month — your business needs to be visible for them. Our trilingual SEO strategy (Punjabi+Hindi+English) gives you an advantage over English-only competitors."
  },
  {
    q: "Can you handle real estate digital marketing in Mohali & New Chandigarh?",
    a: "Yes. Chandigarh and Mohali&apos;s real estate market is growing fast — sectors like Aerocity, New Chandigarh (Mullanpur), Zirakpur and Kharar are active growth corridors. We build lead-capture portals, Google Ads campaigns and social media strategies designed to bring qualified property buyers to your projects."
  },
  {
    q: "Do you offer Punjabi or Hindi language content for SEO?",
    a: "Yes. Punjabi and Hindi language SEO opens up a significantly larger local audience beyond English-only competition. We build trilingual strategies (Punjabi + Hindi + English), which is especially effective for local service businesses targeting Punjab&apos;s heartland from Mohali and Panchkula."
  },
  {
    q: "How much does a website cost in Chandigarh?",
    a: "A professional business website in Chandigarh typically ranges from ₹15,000 to ₹1,50,000+ depending on complexity. We offer transparent pricing with no hidden charges for businesses in Sector 17, Mohali, Panchkula, and across Tricity."
  },
  {
    q: "Do you serve Mohali and Panchkula as well?",
    a: "Yes. We serve the entire Chandigarh Tricity region — Chandigarh (UT), Mohali (Punjab) and Panchkula (Haryana) — as one integrated digital market, with specific experience in Mohali IT Park&apos;s startup ecosystem and Panchkula&apos;s healthcare and residential sectors."
  },
];
    ...
    <div className="min-h-screen bg-[#030f0e] text-white font-sans overflow-x-hidden">
      ...
      >
        ...
        <div className="relative z-10 container mx-auto px-4 py-20 text-center">
          ...
          >
            <Crown className="w-4 h-4" /> Software Agency in Chandigarh Tricity • 30+ Projects Delivered
          </motion.div>
          ...
          >
            SniperCoders helps Chandigarh&apos;s businesses — from <strong className="text-teal-400">Sector 17&apos;s retailers</strong> to <strong className="text-teal-400">Mohali&apos;s IT firms</strong> and <strong className="text-teal-400">Panchkula&apos;s real estate developers</strong> — build the digital presence they need in India&apos;s most planned city.
          </motion.p>
        ...
        <div className="container mx-auto px-4 max-w-5xl">
          ...
          >
            ...
            <div className="space-y-4 text-gray-300 leading-relaxed">
              <p>
                <strong className="text-white">Chandigarh</strong> — Le Corbusier&apos;s masterpiece and India&apos;s most planned city — consistently ranks among the country&apos;s wealthiest urban agglomerations per capita. Together with <strong className="text-teal-400">Mohali (Punjab)</strong> and <strong className="text-teal-400">Panchkula (Haryana)</strong>, the Chandigarh Tricity is a large consumer market with high disposable income, aspirational consumption habits and excellent internet connectivity.
              </p>
              <p>
                <strong className="text-cyan-400">Real estate in New Chandigarh</strong> is growing. <strong className="text-cyan-400">Mohali&apos;s IT park</strong> and <strong className="text-cyan-400">Aerocity</strong> are drawing corporate investment. <strong className="text-cyan-400">Panchkula&apos;s residential zones</strong> are expanding. And across all three cities, restaurants in <strong className="text-white">Sector 17</strong>, gyms in <strong className="text-white">Sector 8</strong>, clinics in <strong className="text-white">Sector 20</strong>, schools in <strong className="text-white">Mohali</strong> and retail stores in <strong className="text-white">Panchkula</strong> compete for the attention of Chandigarh&apos;s online consumers.
              </p>
              <p>
                <strong className="text-white">SniperCoders</strong> works with businesses across Chandigarh Tricity, building digital assets that match the city&apos;s clean aesthetics, high standards and results-driven business culture. <strong className="text-teal-400">Contact us at +91 7006377796 or snipercoders25@gmail.com</strong> for a free consultation.
              </p>
            </div>
          </motion.div>
        </div>
        ...
        <div className="container mx-auto px-4">
          <motion.div initial="hidden" whileInView="show" viewport={{ once: true }} variants={fadeUp} className="text-center mb-14">
            ...
            <p className="text-gray-400 max-w-2xl mx-auto">
              Clean, precise, high-performance digital solutions for Chandigarh&apos;s businesses — web development, mobile apps, SEO, and more.
            </p>
          </motion.div>
        ...
        <div className="container mx-auto px-4 max-w-5xl">
          <motion.div initial="hidden" whileInView="show" viewport={{ once: true }} variants={fadeUp} className="text-center mb-12">
            ...
            <p className="text-gray-400 mt-4 max-w-2xl mx-auto">
              Here&apos;s how we work with Tricity businesses:
            </p>
          </motion.div>
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
            {[
              "Punjabi + Hindi + English trilingual SEO across Tricity",
              "New Chandigarh, Mullanpur & Aerocity real estate lead-gen sites",
              "Mohali IT park — startup product websites & SaaS landing pages built for scale",
              "Chandigarh wedding industry — venue, décor & planner websites with strong portfolios",
              "Clinic & dental website design for Chandigarh&apos;s health market",
              "Restaurant & dhaba discovery SEO for Sector 17, 35 & 26",
              "Gym & fitness studio digital marketing for Chandigarh&apos;s health-conscious audience",
              "Branding matching Chandigarh&apos;s design-forward aesthetics and Le Corbusier&apos;s legacy",
              "Regular working hours aligned with Tricity business hours for calls and meetings",
      ...
      <section className="py-12 bg-gradient-to-r from-teal-900/20 via-cyan-900/10 to-teal-900/20 border-y border-gray-800/50">
        <div className="container mx-auto px-4 text-center">
          ...
          <p className="text-xl md:text-2xl font-medium text-gray-200 max-w-3xl mx-auto">
            We work closely with real estate, hospitality, education, and retail businesses across the Chandigarh Tricity to build websites, apps, and marketing campaigns that bring in real local demand.
          </p>
      ...
      <section className="py-20">
        <div className="container mx-auto px-4 max-w-3xl">
          <motion.div initial="hidden" whileInView="show" viewport={{ once: true }} variants={fadeUp} className="text-center mb-12">
            ...
            <p className="text-gray-400">Common questions about software development, website design, and digital marketing in Chandigarh, Mohali & Panchkula.</p>
          </motion.div>
          ...
          >
            ...
            <div className="relative z-10">
              ...
              <p className="text-gray-300 mb-8 max-w-2xl mx-auto">
                Chandigarh Tricity&apos;s consumers are searching Google right now for businesses like yours. From <strong className="text-teal-400">Sector 17 to Mohali IT Park, Panchkula to New Chandigarh</strong> — SniperCoders helps make sure your business is what they find.
              </p>
