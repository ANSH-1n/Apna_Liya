...
const FAQsPage = () => {
  const [generalQuestions, setGeneralQuestions] = useState<FAQ[]>([
    {
      question: "What is SniperCoders?",
      // ✅ SEO: keyword-rich answer
      answer:
        "SniperCoders is the best software and IT company in India, specializing in custom website development, mobile application development, digital marketing (SEO, Google Ads, Meta Ads), IT consulting, and IoT integration services. We serve clients across Bangalore, Jammu, Kashmir, Delhi, Mumbai, Hyderabad, Pune, Chennai, Chandigarh, Udhampur, and Katra.",
      isOpen: true,
    },
    {
      question: 'What does "SniperCoders" mean?',
    ...
    {
      question: "What areas do you serve?",
      // ✅ SEO: all 11 cities listed
      answer:
        "SniperCoders serves clients globally with a strong presence across India — including Bangalore, Jammu, Kashmir, Delhi, Mumbai, Hyderabad, Pune, Chennai, Chandigarh, Udhampur, and Katra. We are recognized as the best software agency near you in these cities, working remotely with businesses of all sizes across various industries.",
      isOpen: false,
    },
    {
      question: "How experienced is your team?",
    ...
    {
      question: "What makes SniperCoders different from other technology companies?",
      // ✅ SEO: best software agency keyword
      answer:
        "SniperCoders is recognized as the best software agency in India because we combine deep technical expertise with real business understanding. We don't just build technologies — we create solutions that align with your business goals and provide measurable results. Our focus on transparent communication and collaborative development sets us apart from other IT companies.",
      isOpen: false,
    },
  ]);
  ...
  const [serviceQuestions, setServiceQuestions] = useState<FAQ[]>([
    {
      question: "What services does SniperCoders offer?",
      // ✅ SEO: full services list with keywords
      answer:
        "SniperCoders offers custom software development, website development, mobile app development, IT consulting, digital marketing (SEO, Google Ads, Meta Ads), and IoT integration services across India. We are the best website development company and best app development agency, serving clients in Bangalore, Jammu, Kashmir, Delhi, Mumbai, and more. Each service is tailored to meet the specific needs of our clients.",
      isOpen: false,
    },
    {
      question: "Do you offer website maintenance services?",
    ...
    {
      question: "Can you help with both the design and development aspects of a website?",
      answer:
        "Absolutely! We offer end-to-end website solutions, handling everything from UI/UX design to frontend and backend development. Our integrated approach ensures a cohesive and seamless website experience.",
      isOpen: false,
    },
  ...
  const [projectProcessQuestions, setProjectProcessQuestions] = useState<FAQ[]>([
    ...
    },
    {
      question: "How long does it take to complete a website?",
      answer:
        "The timeframe for website development depends on the complexity of the project. A basic informational website typically takes 2–4 weeks, while more advanced e-commerce platforms or custom web applications can require 2–4 months. Once we understand your specific requirements, we'll provide a clear and realistic project timeline tailored to your goals.",
      isOpen: false,
    },
    {
      question: "How long does it take to develop a mobile app?",
      answer:
        "The timeline for mobile app development varies based on the app's complexity, features, and target platforms. Simple applications can be completed within 2–3 months, while more advanced apps with complex functionality may take 3–6 months or longer. After understanding your specific needs, we'll provide a detailed and realistic development timeline.",
      isOpen: false,
    },
    {
      question: "How do you handle project communication?",
  ...
  const [technologyQuestions, setTechnologyQuestions] = useState<FAQ[]>([
    {
      question: "What technologies do you use for web development?",
      answer:
        "We use a wide range of modern web technologies to build high-performance, scalable websites tailored to your needs. Our stack includes front-end technologies like HTML5, CSS3, JavaScript, React, Next.js, Vue.js, and Tailwind CSS; back-end technologies such as Node.js, PHP (Laravel), Python (Django, Flask), and Express.js; and database systems including MySQL, PostgreSQL, and MongoDB. We also work with APIs, cloud services (AWS, Firebase, Vercel), and content management systems like WordPress or Strapi when needed.",
      isOpen: false,
    },
    {
      question: "What programming languages do you use for mobile app development?",
      answer:
        "For mobile app development, we utilize a wide range of technologies to deliver high-performance and scalable applications. For cross-platform development, we use React Native, Flutter, and Ionic. For native development, we use Swift and Objective-C for iOS, and Kotlin and Java for Android. Our backend integrations are supported by Node.js, Django, Firebase, and GraphQL.",
      isOpen: false,
    },
  ]);
  ...
  const [pricingQuestions, setPricingQuestions] = useState<FAQ[]>([
    {
      question: "How much does a website cost?",
      // ✅ SEO: best website development company + India
      answer:
        "Website development costs vary based on the complexity, features, and design requirements. As the best website development company in India, SniperCoders offers competitive pricing tailored to your specific needs — whether you're looking for a basic informational site, a business website, or an advanced web application. We're also open to negotiation to ensure the best value within your budget.",
      isOpen: false,
    },
    {
      question: "How much does mobile app development cost?",
  ...
  const toggleFAQ = (category: string, index: number) => {
    switch (category) {
      case "general":
        setGeneralQuestions(generalQuestions.map((q, i) => i === index ? { ...q, isOpen: !q.isOpen } : q));
        break;
      case "services":
        setServiceQuestions(serviceQuestions.map((q, i) => i === index ? { ...q, isOpen: !q.isOpen } : q));
        break;
      case "gettingStarted":
        setGettingStartedQuestions(gettingStartedQuestions.map((q, i) => i === index ? { ...q, isOpen: !q.isOpen } : q));
        break;
      case "projectProcess":
        setProjectProcessQuestions(projectProcessQuestions.map((q, i) => i === index ? { ...q, isOpen: !q.isOpen } : q));
        break;
      case "technology":
        setTechnologyQuestions(technologyQuestions.map((q, i) => i === index ? { ...q, isOpen: !q.isOpen } : q));
        break;
      case "pricing":
        setPricingQuestions(pricingQuestions.map((q, i) => i === index ? { ...q, isOpen: !q.isOpen } : q));
        break;
      case "support":
        setSupportQuestions(supportQuestions.map((q, i) => i === index ? { ...q, isOpen: !q.isOpen } : q));
        break;
      default:
        break;
    }
  ...
  const renderFAQItem = (question: FAQ, index: number, category: string) => {
    return (
      ...
      >
        <div
          className={`flex justify-between items-center p-4 cursor-pointer ${
            question.isOpen ? "bg-blue-500 text-white" : "bg-white text-gray-800"
          }`}
          onClick={() => toggleFAQ(category, index)}
        >
          <h3 className="text-lg font-medium">{question.question}</h3>
          <FontAwesomeIcon icon={question.isOpen ? faChevronUp : faChevronDown} />
        </div>
        {question.isOpen && (
          <motion.div
            className="p-4 bg-white"
  ...
  const getFilteredFAQs = () => {
    if (activeCategory === "All") {
      return (
        <>
          <section className="mb-8">
            <motion.h2 className="text-xl font-bold mb-4 text-blue-500 flex items-center" initial={{ opacity: 0, x: -20 }} animate={{ opacity: 1, x: 0 }} transition={{ delay: 0.2 }}>
              <span className="mr-2">─</span> General Questions
            </motion.h2>
            {generalQuestions.map((q, i) => renderFAQItem(q, i, "general"))}
          </section>
          <section className="mb-8">
            <motion.h2 className="text-xl font-bold mb-4 text-blue-500 flex items-center" initial={{ opacity: 0, x: -20 }} animate={{ opacity: 1, x: 0 }} transition={{ delay: 0.3 }}>
              <span className="mr-2">─</span> Services
            </motion.h2>
            {serviceQuestions.map((q, i) => renderFAQItem(q, i, "services"))}
          </section>
          <section className="mb-8">
            <motion.h2 className="text-xl font-bold mb-4 text-blue-500 flex items-center" initial={{ opacity: 0, x: -20 }} animate={{ opacity: 1, x: 0 }} transition={{ delay: 0.4 }}>
              <span className="mr-2">─</span> Getting Started
            </motion.h2>
            {gettingStartedQuestions.map((q, i) => renderFAQItem(q, i, "gettingStarted"))}
          </section>
          <section className="mb-8">
            <motion.h2 className="text-xl font-bold mb-4 text-blue-500 flex items-center" initial={{ opacity: 0, x: -20 }} animate={{ opacity: 1, x: 0 }} transition={{ delay: 0.5 }}>
              <span className="mr-2">─</span> Project Process
            </motion.h2>
            {projectProcessQuestions.map((q, i) => renderFAQItem(q, i, "projectProcess"))}
          </section>
          <section className="mb-8">
            <motion.h2 className="text-xl font-bold mb-4 text-blue-500 flex items-center" initial={{ opacity: 0, x: -20 }} animate={{ opacity: 1, x: 0 }} transition={{ delay: 0.6 }}>
              <span className="mr-2">─</span> Technology
            </motion.h2>
            {technologyQuestions.map((q, i) => renderFAQItem(q, i, "technology"))}
          </section>
          <section className="mb-8">
            <motion.h2 className="text-xl font-bold mb-4 text-blue-500 flex items-center" initial={{ opacity: 0, x: -20 }} animate={{ opacity: 1, x: 0 }} transition={{ delay: 0.7 }}>
              <span className="mr-2">─</span> Pricing & Payments
            </motion.h2>
            {pricingQuestions.map((q, i) => renderFAQItem(q, i, "pricing"))}
          </section>
          <section className="mb-8">
            <motion.h2 className="text-xl font-bold mb-4 text-blue-500 flex items-center" initial={{ opacity: 0, x: -20 }} animate={{ opacity: 1, x: 0 }} transition={{ delay: 0.8 }}>
              <span className="mr-2">─</span> Support & Maintenance
            </motion.h2>
            {supportQuestions.map((q, i) => renderFAQItem(q, i, "support"))}
          </section>
    ...
    if (activeCategory === "GeneralQuestions") return <section><motion.h2 className="text-xl font-bold mb-4 text-blue-500 flex items-center" initial={{ opacity: 0, x: -20 }} animate={{ opacity: 1, x: 0 }}><span className="mr-2">─</span> General Questions</motion.h2>{generalQuestions.map((q, i) => renderFAQItem(q, i, "general"))}</section>;
    if (activeCategory === "Services") return <section><motion.h2 className="text-xl font-bold mb-4 text-blue-500 flex items-center" initial={{ opacity: 0, x: -20 }} animate={{ opacity: 1, x: 0 }}><span className="mr-2">─</span> Services</motion.h2>{serviceQuestions.map((q, i) => renderFAQItem(q, i, "services"))}</section>;
    if (activeCategory === "GettingStarted") return <section><motion.h2 className="text-xl font-bold mb-4 text-blue-500 flex items-center" initial={{ opacity: 0, x: -20 }} animate={{ opacity: 1, x: 0 }}><span className="mr-2">─</span> Getting Started</motion.h2>{gettingStartedQuestions.map((q, i) => renderFAQItem(q, i, "gettingStarted"))}</section>;
    if (activeCategory === "ProjectProcess") return <section><motion.h2 className="text-xl font-bold mb-4 text-blue-500 flex items-center" initial={{ opacity: 0, x: -20 }} animate={{ opacity: 1, x: 0 }}><span className="mr-2">─</span> Project Process</motion.h2>{projectProcessQuestions.map((q, i) => renderFAQItem(q, i, "projectProcess"))}</section>;
    if (activeCategory === "Technology") return <section><motion.h2 className="text-xl font-bold mb-4 text-blue-500 flex items-center" initial={{ opacity: 0, x: -20 }} animate={{ opacity: 1, x: 0 }}><span className="mr-2">─</span> Technology</motion.h2>{technologyQuestions.map((q, i) => renderFAQItem(q, i, "technology"))}</section>;
    if (activeCategory === "PricingPayments") return <section><motion.h2 className="text-xl font-bold mb-4 text-blue-500 flex items-center" initial={{ opacity: 0, x: -20 }} animate={{ opacity: 1, x: 0 }}><span className="mr-2">─</span> Pricing & Payments</motion.h2>{pricingQuestions.map((q, i) => renderFAQItem(q, i, "pricing"))}</section>;
    if (activeCategory === "SupportMaintenance") return <section><motion.h2 className="text-xl font-bold mb-4 text-blue-500 flex items-center" initial={{ opacity: 0, x: -20 }} animate={{ opacity: 1, x: 0 }}><span className="mr-2">─</span> Support & Maintenance</motion.h2>{supportQuestions.map((q, i) => renderFAQItem(q, i, "support"))}</section>;
    return null;
  };
  ...
  return (
    <>
      ...
      <Head>
        <title>FAQs | SniperCoders - Best Software Agency in India</title>
        <meta
          name="description"
      ...
      <div className="min-h-screen bg-gray-900 text-white relative overflow-hidden">
        ...
        <header className="relative z-10 pt-8 pb-4 px-6 md:px-12">
          <div className="flex justify-between items-center">
            {/* ✅ SEO: Breadcrumb with Services link */}
        ...
        <main className="relative z-10 px-6 md:px-12 py-8">
          ...
          >
            ...
            <h1 className="text-3xl font-bold mb-2">
              FAQs – SniperCoders Best Software Agency in India
            </h1>
            {/* ✅ SEO: Intro with services + cities */}
            <p className="text-gray-300">
              Find answers to common questions about <strong>SniperCoders</strong> — the best software and IT
              company in India offering website development, mobile app development, digital marketing, and IT
              consulting across Bangalore, Jammu, Kashmir, Delhi, Mumbai, Hyderabad, Pune, Chennai, Chandigarh,
              Udhampur, and Katra. Explore our FAQs to learn how we can help your business succeed.
            </p>
          </motion.div>
          ...
          <div className="max-w-4xl mx-auto mt-12">
            ...
            >
              <motion.h2
                ...
                transition={{ duration: 0.5, delay: 0.2 }}
              >
                Frequently Asked Questions – Best IT Company in India
              </motion.h2>
              <motion.p
                className="text-gray-600 mb-6"
                initial={{ opacity: 0 }}
                ...
                transition={{ duration: 0.5, delay: 0.3 }}
              >
                Find answers to common questions about our website development, app development, digital marketing,
                pricing, and support services in India.
              </motion.p>
          ...
          <div className="container mx-auto px-6">
            <div className="grid grid-cols-1 md:grid-cols-4 gap-12">
              <motion.div variants={textVariants} initial="initial" animate="animate">
                ...
                {/* ✅ SEO: footer description with keywords */}
                <p className="text-gray-300 text-sm leading-relaxed">
