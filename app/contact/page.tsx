...
//       const whatsappNumber = "917006377796"; // Example: 917006377796 for +91 7006377796
...
//       setSubmitStatus({
//         type: "success",
//         message: "Redirecting to WhatsApp... Please send the pre-filled message to complete your inquiry.",
//       });
...
//       setSubmitStatus({
//         type: "error",
//         message: "Something went wrong. Please try contacting us directly via WhatsApp.",
//       });
//     } finally {
//       setLoading(false);
//     }
...
//                   <AiOutlineLinkedin size={20} className="sm:text-2xl" />
//                 </a>
//                 <a href="https://wa.me/917006377796" target="_blank" rel="noopener noreferrer" className="text-green-500 hover:text-green-400">
//                   <AiOutlineWhatsApp size={20} className="sm:text-2xl" />
//                 </a>
//                 <a href="#" className="text-red-500 hover:text-red-400">
//                   <AiOutlineYoutube size={20} className="sm:text-2xl" />
...
//             <div className="mb-6 md:mb-8">
//               <button 
//                 onClick={() => window.open('https://wa.me/917006377796?text=Hi%2C%20I%20would%20like%20to%20schedule%20a%20free%20consultation', '_blank')}
//                 className="w-full py-3 sm:py-4 rounded-full bg-gradient-to-r from-blue-500 to-purple-500 hover:from-blue-600 hover:to-purple-600 transition-all transform hover:scale-105 font-bold text-sm sm:text-base"
//               >
//                 Schedule a Free Consultation
//               </button>
//             </div>
...
//               <button
//                 type="submit"
//                 className={`w-full py-3 sm:py-4 bg-blue-500 rounded-lg hover:bg-blue-600 transition-colors transform hover:scale-105 font-bold text-sm sm:text-base flex items-center justify-center gap-2 ${
//                   loading ? 'opacity-75 cursor-not-allowed' : ''
//                 }`}
//                 disabled={loading}
//               >
